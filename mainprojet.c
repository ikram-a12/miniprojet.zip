  ...
  int Location_Voiture()
{
     ...
     printf("\n                      *******************************************************************************************************************************************************************************************");
	 printf("\n                       \***                                                                \***");
	 printf("\n                       \***     Visualiser contrat__________________________________1      \***");
	 printf("\n                       \***      Louer voiture______________________________________2      \***");
	 printf("\n                       \***     Retourner voiture___________________________________3      \***");
	 printf("\n                       \***      Modifier contrat___________________________________4      \***");
	 printf("\n                       \***      Retour_____________________________________________5      \***");
	 printf("\n                       \***                                                                \***");
	 printf("\n                       *******************************************************************************************************************************************************************************************");
	 printf("\n\n                                          Votre choix  :  ");
...
void Liste_Voiture(voiture *v,int n)
{
	char chaine[t_max]="";
 FILE*fichier=NULL;
   fichier=fopen("listvoiture.txt","r");
   if (fichier!=NULL)
   {
       while(fgets(chaine,t_max,fichier)!=NULL)
       {printf("%s",chaine);
...
void Ajouter_Voiture()
{
    ...
    scanf("%d",&nb);
    FILE *fichier=NULL;
fichier=fopen("listvoiture.txt","a");
  if (fichier != NULL)
{
    ...
    for(i=0;i<nb;i++){
        ...
        scanf("%s",v.EnLocation);
          ...
          fprintf(fichier,"l'id voiture:%d,marque:%s,Nom:%s,couleur:%s,nombre de place:%d,le prix d'un jour:%d,en location:%s\n",v.idVoiture,v.marque,v.nomVoiture,v.couleur,v.nbrPlace,v.prixJour,v.EnLocation);
					fclose(fichier);
...
void Supprimer_Voiture()
{
    ...
    int id;
    fichier = fopen("listvoiture.txt","r");
    file = fopen("supprimer.txt","a");
    if(fichier != NULL && file != NULL){
       // system("cls");
        printf("Entrer l'id du voiture que vous pouvez supprimer : \n");
        scanf("%d",&id);
        while(!feof(fichier)){
            fscanf(fichier,"%d %s %s %s %d %d %s \n",&v.idVoiture,v.marque,v.nomVoiture,v.couleur,&v.nbrPlace,&v.prixJour,v.EnLocation);
            if(v.idVoiture != id)
                fprintf(file,"%d %s %s %s %d %d %s %d \n",v.idVoiture,v.marque,v.nomVoiture,v.couleur,v.nbrPlace,v.prixJour,v.EnLocation);
        }
        fclose(fichier);
        fclose(file);
        remove("listvoiture.txt");
        rename("supprimer.txt","listvoiture.txt");
        printf("Bravo !!");
    }
	Gestion_Voiture();
}
...
void Supprimer_Client()
{
    ...
    client v;
    int id;
    fichier = fopen("listclient.txt","r");
    file = fopen("supprimerclient.txt","a");
    if(fichier != NULL && file != NULL){
       // system("cls");
        printf("Entrer l'id du client que vous pouvez supprimer : \n");
        scanf("%d",&id);
        while(!feof(fichier)){
        fscanf(fichier,"%d %s %s %d %s %d \n",&v.idClient,v.nom,v.prenom,&v.cin,v.adresse,&v.telephone);
            if(v.idClient != id)
                fprintf(file,"id client:%d,Nom:%s,Prenom:%s,cin:%d,l'adresse:%s,numero de telephone:%d \n",v.idClient,v.nom,v.prenom,v.cin,v.adresse,v.telephone);
        }
        fclose(fichier);
        fclose(file);
        remove("listclient.txt");
        rename("supprimerclient.txt","listclient.txt");
        printf("Bravo !!");
	Gestion_Client();
}}
